      ...
      <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="active" href="wilayah.php">Wilayah</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" >
              ...
              <div class="col-md-12">
                <div class="content-panel">
                  <table class="table table-striped table-advance table-hover">
                    <h4><i class="fa fa-angle-right"></i> Tabel Wilayah</h4>
                    <hr>
                    &nbsp;&nbsp;<a href="tambah_wilayah.php"><button class='btn btn-primary btn-xs'><i class='fa fa-plus'> Tambah Data</i></button></a>
                    <thead>
                      <tr>
                        <th ><i class="fa fa-bookmark"></i>Id Wilayah</th>
                        <th ><i class="fa fa-bookmark"></i>Kode Wilayah</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        $perintah = $_mysqli -> query ("Select * from wilayah"); /*melihat tabel 1541180070_nickho*/
                        ...
                        echo "<tr>";
                          ...
                          $b = $baris[$i][0];
                          echo "<td>
                            <a href='update_wilayah.php?id=$b'><button class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></button></a>
                            <a href='delete_wilayah.php?id=$b'><button class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i></button></a>
                          </td>";
                        echo "</tr>";
                        }
                        echo "<table>";

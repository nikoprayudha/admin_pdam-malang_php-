      ...
      <div id="sidebar"  class="nav-collapse ">
        ...
        <section id="main-content">
          <section class="wrapper">
            ...
            <h3>&nbsp;&nbsp;Form Update Pemetaan</h3>
            <div class="form-panel" style="width:98%;">
        
              <form class="form-horizontal style-form" method="post" action="proses_update_pemetaan.php">
                        <?php
                $konfirmasi = $_GET["id"]; /*ambil data yang di pilih */
                $_mysqli = new mysqli("localhost","root","","pdam"); /*database*/
                $perintah = $_mysqli -> query("select * from pemetaan where id_pemetaan = '".$konfirmasi."' "); /*query update*/
                $baris=$perintah->fetch_all(); /*menampilkan data semuanaya*/
                ?>
                    <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Id Pemetaan</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="pemetaanid"  value="<?php echo $baris[0][0]; ?>"  readonly required>
                  </div>
                </div>
               
                 <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Id Wilayah</label>
                  <div class="col-sm-10">
                    <select class="form-control" name="wilayahid" required >
                          <option><?php echo $baris[0][1]; ?></option>
                          <option value ="">---PILIH ID Wilayah ---</option>
                                <?php
                                $obj=new mysqli("localhost","root","","pdam");
                                $queryusers = "SELECT * FROM wilayah ";
                                $obj = mysqli_query($obj, $queryusers);
                                while ( $d=mysqli_fetch_assoc($obj)) {
                                echo "<option>".$d['id_wilayah']."</option>";
                                }
                                ?>
                     </select>           
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="lokasi" value="<?php echo $baris[0][2]; ?>"  required>
                  </div>
                </div>
             
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Kode Pipa</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="kodepipa" value="<?php echo $baris[0][3]; ?>"  required>
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <select name="status" class="form-control">
                      <option><?php echo $baris[0][4]; ?></option>

        ...
        <section id="main-content">
          <section class="wrapper">
            ...
            <div class="form-panel" style="width:98%;">
              ...
              <form class="form-horizontal style-form" method="post" action="proses_tambah_wilayah.php">
                        
                    <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Id Wilayah</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="wilayahid" placeholder="Id wilayah" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Kode Wilayah</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="kode" placeholder="Kode Wilayah" required>
                  </div>
                </div>

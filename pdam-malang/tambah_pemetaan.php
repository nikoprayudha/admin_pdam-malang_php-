      ...
      <div id="sidebar"  class="nav-collapse ">
        ...
        <section id="main-content">
          <section class="wrapper">
            ...
            <h3>&nbsp;&nbsp;Form Tambah Pemetaan</h3>
            <div class="form-panel" style="width:98%;">
        
              <form class="form-horizontal style-form" method="post" action="proses_tambah_pemetaan.php">
                        
                    <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Id Pemetaan</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="pemetaanid" placeholder="id pemetaan"required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="kodepipa" placeholder="kode pipa" required>
                  </div>
                </div>

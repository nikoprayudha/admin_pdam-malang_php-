              ...
              <div class="col-md-12">
                <div class="content-panel">
                  <table class="table table-striped table-advance table-hover">
                    <h4><i class="fa fa-angle-right"></i> Tabel Pegawai</h4>
                    <hr>
                     &nbsp;&nbsp;<a href="tambah_pegawai.php"><button class='btn btn-primary btn-xs'><i class='fa fa-plus'> Tambah Data</i></button></a> 
                    <thead>
                      <tr>
                        <th width="100px"><i class="fa fa-bookmark"></i>Id Pegawai</th>
                        <th width="100px"><i class="fa fa-bookmark"></i>Nama</th>
                        <th width="130px"><i class="fa fa-bookmark"></i>Jenis Kelamin</th>
                        <th width="100px"><i class="fa fa-bookmark"></i>Tmp Lahir</th>
                        <th width="100px"><i class="fa fa-bookmark"></i>Tgl Lahir</th>
                        <th width="150px"><i class="fa fa-bookmark"></i>Alamat</th>
                        <th width="100px"><i class="fa fa-bookmark"></i>Telepon</th>
                        <th width="100px"><i class="fa fa-bookmark"></i>Username</th>
                        <th width="100px"><i class="fa fa-bookmark"></i>Password</th>
                        <th width="100px"><i class="fa fa-bookmark"></i>Profesi</th>
                        <th width="100px"><i class=" fa fa-edit"></i> Status</th>
...
$perintah = $_mysqli -> query ("Select * from pegawai"); /*melihat tabel 1541180070_nickho*/
...
$b = $baris[$i][0];
 echo "<td>
<a href='update_pegawai.php?id=$b'><button class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></button></a>
<a href='delete_pegawai.php?id=$b'><button class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i></button></a>
      </td>";
echo "</tr>";
}
echo "<table>";

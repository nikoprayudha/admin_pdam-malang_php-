        ...
        <section id="main-content">
          <section class="wrapper">
            ...
            <div class="form-panel" style="width:98%;">
              ...
              <form class="form-horizontal style-form" method="post" action="proses_tambah_pengatur.php">
                        
                    <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Id Pengatur</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="pengaturid" placeholder="id pengatur"required>
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="pemetaanid" required>
                          <option value ="">---PILIH ID Pemetaan ---</option>
                                ...
                                $queryusers = "SELECT * FROM pemetaan where status='Tersedia' ";
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="tandon" placeholder="tandon" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="pintuair" placeholder="pintu air" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="meterair" placeholder="meter air" required>
                  </div>
                </div>

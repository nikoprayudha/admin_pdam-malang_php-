        ...
        <section id="main-content">
          <section class="wrapper">
            ...
            <div class="form-panel" style="width:98%;">
              ...
              <form class="form-horizontal style-form" method="post" action="proses_update_wilayah.php">
                <?php
                $konfirmasi = $_GET["id"]; /*ambil data yang di pilih */
                $_mysqli = new mysqli("localhost","root","","pdam"); /*database*/
                $perintah = $_mysqli -> query("select * from wilayah where id_wilayah ='".$konfirmasi."' "); /*query update*/
                $baris=$perintah->fetch_all(); /*menampilkan data semuanaya*/
                ?>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Id Wilayah</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="wilayahid" value="<?php echo $baris[0][0]; ?>" readonly required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Kode Wilayah</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="kode" value="<?php echo $baris[0][1]; ?>" required>
                  </div>
                </div>

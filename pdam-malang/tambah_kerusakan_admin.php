        ...
        <section id="main-content">
          <section class="wrapper">
            ...
            <div class="form-panel" style="width:98%;">
              ...
              <form class="form-horizontal style-form" method="post" action="proses_tambah_kerusakan_admin.php">
                        
                    <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Id Kerusakan</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="kerusakanid" placeholder="id kerusakan"required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="statuskerusakan" class="form-control">

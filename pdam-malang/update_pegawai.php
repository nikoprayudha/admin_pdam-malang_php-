        ...
        <section id="main-content">
          <section class="wrapper">
            ...
            <div class="form-panel" style="width:98%;">
              ...
              <form class="form-horizontal style-form" method="post" action="proses_update_pegawai.php">
                        <?php
                        $konfirmasi = $_GET["id"]; /*ambil data yang di pilih */
                        $_mysqli = new mysqli("localhost","root","","pdam"); /*database*/
                        $perintah = $_mysqli -> query("select * from pegawai where id_pegawai ='".$konfirmasi."' "); /*query update*/
                        $baris=$perintah->fetch_all(); /*menampilkan data semuanaya*/
                        ?>
                    <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Id Pegawai</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="pegawaiid"value="<?php echo $baris[0][0]; ?>" readonly required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Nama</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="nama" value="<?php echo $baris[0][1]; ?>"required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="radio">
                            <?php
                            if($baris[0][2] == 'laki-laki') /*jika jenis kelamin = laki-laki*/
                            {
                            echo ' <label><input type="radio" name="jk" value="laki-laki" checked>laki-laki </label>
                             <label><input type="radio" name="jk" value="perempuan">perempuan </label>';
                            }
                            else /*jika tidak maka akan tampil perempuan*/
                            {
                            echo '<label><input type="radio" name="jk" value="laki-laki">laki-laki</label>
                            <label><input type="radio" name="jk" value="perempuan" checked>perempuan</label>';
                            }
                            ?>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="tmplahir" value="<?php echo $baris[0][3]; ?>" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Tanggal Lahir</label>
                  <div class="col-sm-10">
                    <input type="date"  class="form-control" name="tgllahir" value="<?php echo $baris[0][4]; ?>" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Alamat</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" name="alamat" required><?php echo $baris[0][5];?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Telepon</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="telepon" value="<?php echo $baris[0][6]; ?>" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Username</label>
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" name="username" value="<?php echo $baris[0][7]; ?>" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Password</label>
                  <div class="col-sm-10">
                    <input type="password"  class="form-control" name="password" value="<?php echo $baris[0][8]; ?>" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="profesi" required>
                      <option><?php echo $baris[0][9];?></option>
                ...
                <input type="submit" class="btn btn-success" name="simpan" value="simpan" onClick="return confirm('Apakah anda yakin ingin mengupdate?');">

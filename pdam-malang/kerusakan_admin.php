      ...
      <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a  href="kerusakan_admin.php">Daftar Laporan Kerusakan </a></li>
            </ul>
            <ul class="sub">
                  ...
                  <table class="table table-striped table-advance table-hover">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th width="100px"><i class="fa fa-bookmark"></i>Keterangan</th>
                        ...
                        <th width="100px"><i class="fa fa-bookmark"></i>Action</th>
...
$b = $baris[$i][0];
echo "<td>
  <a href='delete_kerusakan_admin.php?id=$b'><button class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i></button></a>
</td>";
echo "</tr>";
}
echo "<table>";
?>
            <hr>
            <center><p>*NP : JIKA STATUS SUDAH <FONT color="blue"><b>TERSEDIA</b></FONT> , DI MOHON ADMIN SEGERA MEGUBAH INFROMASI DATA PEMETAAN</p></center>
                      </tr>     
                              </tbody>
                            </table>
                          </div><!-- /content-panel -->

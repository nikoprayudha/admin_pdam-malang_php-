...
echo $_mysqli ->query($perintah); /*mengambil dari perintah*/
	...
	echo "<script>alert('tambah data succes');window.location='pegawai.php'</script>";/*data berhasil disimpan */
	}
	else {
	echo "<script>alert('gagal tambah data ');window.location='tambah_pegawai.php'</script>";/*data berhasil disimpan */ /*data gagal disimpan*/
	}
?>